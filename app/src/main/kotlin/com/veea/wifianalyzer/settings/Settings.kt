 ...
 */
package com.veea.wifianalyzer.settings

import android.content.SharedPreferences.OnSharedPreferenceChangeListener
import com.veea.annotation.OpenClass
import com.veea.util.buildMinVersionQ
import com.veea.util.defaultCountryCode
import com.veea.util.defaultLanguageTag
import com.veea.util.findByLanguageTag
import com.veea.util.findOne
import com.veea.util.findSet
import com.veea.util.ordinals
import com.veea.wifianalyzer.R
import com.veea.wifianalyzer.navigation.NavigationGroup
import com.veea.wifianalyzer.navigation.NavigationMenu
import com.veea.wifianalyzer.wifi.accesspoint.AccessPointViewType
import com.veea.wifianalyzer.wifi.accesspoint.ConnectionViewType
import com.veea.wifianalyzer.wifi.band.WiFiBand
import com.veea.wifianalyzer.wifi.graphutils.GraphLegend
import com.veea.wifianalyzer.wifi.model.GroupBy
import com.veea.wifianalyzer.wifi.model.Security
import com.veea.wifianalyzer.wifi.model.SortBy
import com.veea.wifianalyzer.wifi.model.Strength
...
class Settings(private val repository: Repository) {
    ...
    fun themeStyle(): ThemeStyle = ThemeStyle.LIGHT
    // find(ThemeStyle.entries, R.string.theme_key, ThemeStyle.DARK)
